const posts = [
    {
        ...
        author: "Alice Kim",
        coverImage: "/images/meetballs-cover.jpeg",
        excerpt:
    ...
    },
    {
        ...
        author: "Alice Kim",
        coverImage: "/images/tuna-salad-cover.jpeg",
    ...
    },
    {
        ...
        author: "Alice Kim",
        coverImage: "/images/chicken-soup-cover.jpeg",
        excerpt:
...
export function getAllSlugs() {
    let slugs = [];
    getAllPosts().map(post => slugs.push(`/blog/${post.slug}`));
    return slugs;
}
